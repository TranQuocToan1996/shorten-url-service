...
- You do not need to build a scalable service for this challenge.
...
Make sure you reply to the email the answer that includes all information that related to the result of the assignment, eg: url to your git-repo, url to your live demo version, extra documentation ...